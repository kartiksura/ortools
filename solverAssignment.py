...
def main():
    ...
    # Variables
    # x[i,j] = 1 if task j is assigned to worker i
    ...
    solver.Add(solver.AllowedAssignments([works[0], works[1], works[2], works[3]],
                                        group1))
    solver.Add(solver.AllowedAssignments([works[4], works[5], works[6], works[7]],
                                        group2))
    solver.Add(solver.AllowedAssignments([works[8], works[9], works[10], works[11]],
                                        group3))
